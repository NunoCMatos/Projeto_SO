...
/// Prints all events and their reservations.
/// @param out_fd File descriptor to print the events and their reservations to.
/// @return 0 if the events and their reservations were printed successfully, 1 otherwise.
